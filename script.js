...
function animate(){
    ...
    ctx.drawImage(backgroundImage2,bx,0);
    ctx.drawImage(backgroundImage3,bx,0);
    ctx.drawImage(backgroundImage4,bx,0);
    ctx.drawImage(backgroundImage5,bx,0);
    ctx.drawImage(backgroundImage1,bbx,0);
    ctx.drawImage(backgroundImage2,bbx,0);
    ctx.drawImage(backgroundImage3,bbx,0);
    ctx.drawImage(backgroundImage4,bbx,0);
    ctx.drawImage(backgroundImage5,bbx,0);
